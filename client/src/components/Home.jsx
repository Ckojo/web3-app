...
const Input = ({ placeholder, name, type, value }) => (
  <input
    ...
    className="my-2 w-full rounded-small p-2 px-4 outline-none bg-transparent text-white border-none text-sm white-glassmorphism"
  />
)
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <button
            ...
            className="flex flex-ro justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bt]">
